...
public class AdcBaseTest {
	...
	public void launchBrowser(String url) {
		...
		try {
			...
			driver.get(url);
			AdcReports.reportStep("PASS", "Browser launched successfully with " + url);
		} catch (Exception ex) {

			AdcReports.reportStep("FAIL", "Problem While Launching the browser" + url);
			ex.printStackTrace();
		}
	}
	...
	public void typeText(WebElement ele, String text) {
		...
		try {
			...
			ele.sendKeys(text);
			AdcReports.reportStep("PASS", "The given " + text + " was entered successfully to the " + ele);
		} catch (Exception ex) {
			AdcReports.reportStep("FAIL", "The given " + text + "was not entered successfully to the " + ele);
			ex.printStackTrace();
		}
	}
	...
	public void clickAction(WebElement ele) {
		...
		try {
			...
			ele.click();
			AdcReports.reportStep("PASS", "The " + ele.getText() + " was clicked successfully");

		} catch (Exception e) {
			AdcReports.reportStep("FAIL", "The" + ele.getText() + "wasn't clicked successfully");
	...
	public void waitForElement(WebElement ele) {
		...
		try {
			...
			AdcReports.reportStep("PASS", "The" + ele.getText() + " waited successfully to meet the expected conditions");
		} catch (Exception e)

		{
			AdcReports.reportStep("FAIL","Problem while Waiting for the element to meet the expected conditions");
			e.printStackTrace();
		}
	...
	public void pollingWait(WebElement ele) {
		try {
			...
			Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofNanos(30))
	...
	public void jsClick(WebElement ele) {
		...
		try {
			...
			AdcReports.reportStep("FAIL", "The " + ele.getText() + " was not clicked");
	...
	public void screenShotMethod(String ssname) {
		...
		try {
			...
			File dest = new File(
					"C:\\Users\\ganes\\OneDrive\\Desktop\\Screenshot\\SeleniumScreenshot_" + ssname + ".png");
	...
	public void BrokenUrl() {
		...
		for(int i = 0; i < links.size(); i++)
		{
		    ...
		    HttpURLConnection internet = (HttpURLConnection)link.openConnection();
		    internet.connect();
		     
		    int status = internet.getResponseCode();
		     
		    if(status >=400)
		    {
		         System.out.println(url + " Broken Link: " + status);
		    } 
		    else
		    {
		         System.out.println(url + " Valid Link: " + status);
		    } 
		
		    AdcReports.reportStep("PASS", "The Given Browser Link was Verified");
		}
		}
