...
public class AdcReports implements ITestListener {
...
// git changes
	...
	public void startReport() {
		...
		try {
			...
			sparkReporter_Alltest.config().setDocumentTitle("Aura Data Corp Automation Report");
			sparkReporter_Alltest.config().setReportName("Aura Data Corp WebAutomation Results");
			...
			extentReports = new ExtentReports();
			sparkReporter_FailedTest.config().setDocumentTitle("Aura Data Corp  Automation Report");
			sparkReporter_FailedTest.config().setReportName("Aura Data Corp  WebAutomation Results");
			...
			extentReports = new ExtentReports();
			sparkReporter_SkippedandWarningtest.config().setDocumentTitle("Aura Data Corp  Automation Report"); 
			sparkReporter_SkippedandWarningtest.config().setReportName("Aura Data Corp  WebAutomation Results");
